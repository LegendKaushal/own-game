      ...
      var ground,p1,B1,pickupMode,endPortal1,B2,B3,B4
...
function setup(){
  ...
  createCanvas(displayWidth,displayHeight)
   ...
   //Level 1
   ground = new Ground(displayWidth/2,displayHeight/4*3,displayWidth/2,40,true)
   ground2 = new Ground(displayWidth/2,displayHeight/4*2,displayWidth/4,40,true)
   ground3 = new Ground(displayWidth/2-displayWidth/4-20,displayHeight/2 +12,40,400,true)
   ground4 = new Ground(displayWidth/2+displayWidth/4+20,displayHeight/2+12,40,400,true)
   ground5 = new Ground(displayWidth/4+80,displayHeight/8*2+25,100,40,true)
   ...
   p1 = new Player(displayWidth/2,500,50)
...
function draw(){
  if (frameCount %60 ==0){
    Matter.SAT.collides(p1, ground).collided
  }
  ...
  camera.y = p1.body.position.y
   ...
   Matter.SAT.collides(p1.body, ground.body,ground.body); 
  if (ground.body) 
  { console.log("true") 
  }
